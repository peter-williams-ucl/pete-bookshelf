...
(window.Modernizr = (function(a, b, c) {
  ...
  var d = '2.5.3',
    ...
    w = function(a, c, d, e) {
      ...
      return (f = ['&#173;', '<style>', a, '</style>'].join('')), (k.id = h), ((l
        ? k
        : m).innerHTML += f), m.appendChild(k), l || ((m.style.background = ''), g.appendChild(m)), (i = c(k, a)), l
  ...
  return z(''), (i = k = null), (function(a, b) {
    ...
    (function() {
      ...
      (a.innerHTML = '<xyz></xyz>'), (e = 'hidden' in a), (f =
    ...
    this,
    b
  ), (e._version = d), (e._prefixes = m), (e._domPrefixes = p), (e._cssomPrefixes = o), (e.testProp = function(a) {
    return D([a]);
  }), (e.testAllProps = F), (e.testStyles = w), (g.className =
    g.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') + (f ? ' js ' + t.join(' ') : '')), e;
  ...
  function i(a, c, d, e, f, i, j) {
    ...
    y[c] === 1 && ((r = 1), (y[c] = []), (l = b.createElement(a))), a == 'object'
      ? (l.data = c)
  ...
  (B = function(a) {
    ...
    function g(a, e, f, g, i) {
      var j = b(a),
        l = j.autoCallback;
      j.url.split('.').pop().split('?').shift(), j.bypass ||
        (
