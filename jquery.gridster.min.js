/*! gridster.js - v0.7.0 - 2016-02-26 - * https://dsmorse.github.io/gridster.js/ - Copyright (c) 2016 ducksboard; Licensed MIT */ !(function(
  a,
  b
) {
  'use strict';
  'object' == typeof exports
    ...
    : 'function' == typeof define && define.amd
      ? define('gridster-coords', ['jquery'], b)
      : (a.GridsterCoords = b(a.$ || a.jQuery));
})(this, function(a) {
  'use strict';
  function b(b) {
    return b[0] && a.isPlainObject(b[0])
      ? (this.data = b[0])
      : (this.el = b), (this.isCoords = !0), (this.coords = {}), this.init(), this;
  }
  var c = b.prototype;
  return (c.init = function() {
    ...
    if (
      (
        c &&
          !a &&
          ((this.data = c.offset()), (this.data.width = c[0].scrollWidth), (this.data.height = c[0].scrollHeight)),
        c && a && !b
      )
    ) {
      var d = c.offset();
    ...
    var e = this.data;
    return void 0 === e.left && (e.left = e.x1), void 0 === e.top && (e.top = e.y1), (this.coords.x1 =
      e.left), (this.coords.y1 = e.top), (this.coords.x2 = e.left + e.width), (this.coords.y2 =
      e.top + e.height), (this.coords.cx = e.left + e.width / 2), (this.coords.cy =
      e.top + e.height / 2), (this.coords.width = e.width), (this.coords.height = e.height), (this.coords.el =
      c || !1), this;
  }), (c.update = function(b) {
  ...
  function c(b, c, e) {
    (this.options = a.extend(
      d,
      e
    )), (this.$element = b), (this.last_colliders = []), (this.last_colliders_coords = []), this.set_colliders(c), this.init();
  }
  ...
  return (e.init = function() {
    ...
    var c = !1,
      d = !1;
    return ((b.x1 >= a.x1 && b.x1 <= a.x2) || (b.x2 >= a.x1 && b.x2 <= a.x2) || (a.x1 >= b.x1 && a.x2 <= b.x2)) &&
      (c = !0), ((b.y1 >= a.y1 && b.y1 <= a.y2) || (b.y2 >= a.y1 && b.y2 <= a.y2) || (a.y1 >= b.y1 && a.y2 <= b.y2)) &&
      (d = !0), c && d;
  }), (e.detect_overlapping_region = function(a, b) {
    var c = '',
      d = '';
    return a.y1 > b.cy && a.y1 < b.y2 && (c = 'N'), a.y2 > b.y1 && a.y2 < b.cy && (c = 'S'), a.x1 > b.cx &&
      a.x1 < b.x2 &&
      (d = 'W'), a.x2 > b.x1 && a.x2 < b.cx && (d = 'E'), c + d || 'C';
    ...
    for (
      var c = this,
        ...
        h = g.length,
        i = c.$element.coords().update(b || !1).get();
      h--;
    ...
    return (c.options.on_overlap_stop || c.options.on_overlap_start) &&
      this.manage_colliders_start_stop(
        e,
        c.options.on_overlap_start,
        c.options.on_overlap_stop
      ), (this.last_colliders_coords = e), f;
  }), (e.get_closest_colliders = function(a) {
    var b = this.find_collisions(a);
    return b.sort(function(a, b) {
      return 'C' === a.region && 'C' === b.region
        ? a.coords.y1 < b.coords.y1 || a.coords.x1 < b.coords.x1 ? -1 : 1
        : (a.area < b.area, 1);
    }), b;
  }), (e.set_colliders = function(b) {
    'string' == typeof b || b instanceof a
      ? (this.$colliders = a(b, this.options.colliders_context).not(this.$element))
      : (this.colliders = a(b));
  ...
  'object' == typeof exports
    ? (module.exports = b(require('jquery')))
    : 'function' == typeof define && define.amd
      ? define('gridster-draggable', ['jquery'], b)
      : (a.GridsterDraggable = b(a.$ || a.jQuery));
})(this, function(a) {
  'use strict';
  function b(b, d) {
    (this.options = a.extend(
      ...
      c,
      d
    )), (this.$document = a(document)), (this.$container = a(b)), (this.$scroll_container = this.options.scroll_container === window ? a(window) : this.$container.closest(this.options.scroll_container)), (this.is_dragging = !1), (this.player_min_left = 0 + this.options.offset_left), (this.id = i()), (this.ns = '.gridster-draggable-' + this.id), this.init();
  }
  var c = {
      items: 'li',
      distance: 1,
  ...
  return (j.init = function() {
    ...
    this.calculate_dimensions(), this.$container.css(
      'position',
      'static' === b ? 'relative' : b
    ), (this.disabled = !1), this.events(), d.bind(
      this.nsEvent('resize'),
      throttle(a.proxy(this.calculate_dimensions, this), 200)
    );
    ...
    }), this.$container.on(this.nsEvent('selectstart'), a.proxy(this.on_select_start, this)), this.$container.on(
      this.pointer_events.start,
      this.options.items,
      a.proxy(this.drag_handler, this)
    ), this.$document.on(
    ...
    var b = this.get_mouse_pos(a),
      ...
      e = Math.round(
        this.el_init_offset.left + c - this.baseX + this.$scroll_container.scrollLeft() - this.scroll_container_offset_x
      ),
      f = Math.round(
        this.el_init_offset.top + d - this.baseY + this.$scroll_container.scrollTop() - this.scroll_container_offset_y
      );
    return this.options.limit &&
      (e > this.player_max_left
        ? (e = this.player_max_left)
        : e < this.player_min_left && (e = this.player_min_left)), {
    ...
    return a || (a = this.$container.width()), (this.player_max_left =
      a - this.player_width + -this.options.offset_left), (this.options.container_width = a), this;
    ...
    c =
      this.$scroll_container === window
        ? j ? this.$scroll_container.width() : this.$scroll_container.height()
        : j ? this.$scroll_container[0].scrollWidth : this.$scroll_container[0].scrollHeight;
    var l,
      ...
      s = o + b.pointer[d],
      t = c - k + m;
    return s >= q && ((l = n + h), t > l && (this.$scroll_container[i](l), (this['scroll_offset_' + a] += h))), r >=
      s && ((l = n - h), l > 0 && (this.$scroll_container[i](l), (this['scroll_offset_' + a] -= h))), this;
    ...
    if (!this.disabled && (1 === b.which || f) && !this.ignore_drag(b)) {
      var c = this,
        d = !0;
      return (this.$player = a(b.currentTarget)), (this.el_init_pos = this.get_actual_pos(
        this.$player
      )), (this.mouse_init_pos = this.get_mouse_pos(b)), (this.offsetY =
        this.mouse_init_pos.top - this.el_init_pos.top), this.$document.on(this.pointer_events.move, function(a) {
        var b = c.get_mouse_pos(a),
          e = Math.abs(b.left - c.mouse_init_pos.left),
          f = Math.abs(b.top - c.mouse_init_pos.top);
        return e > c.options.distance || f > c.options.distance
          ? d ? ((d = !1), c.on_dragstart.call(c, a), !1) : (c.is_dragging === !0 && c.on_dragmove.call(c, a), !1)
          : !1;
      }), f ? void 0 : !1;
    }
    ...
    return (this.baseX = Math.round(b.left)), (this.baseY = Math.round(b.top)), 'clone' === this.options.helper
      ? ((this.$helper = this.$player.clone().appendTo(this.$container).addClass('helper')), (this.helper = !0))
      : (this.helper = !1), (this.scroll_container_offset_y = this.$scroll_container.scrollTop()), (this.scroll_container_offset_x = this.$scroll_container.scrollLeft()), (this.el_init_offset = this.$player.offset()), (this.player_width = this.$player.width()), this.set_limits(
      this.options.container_width
    ), this.options.start && this.options.start.call(this.$player, a, this.get_drag_data(a)), !1;
  }), (j.on_dragmove = function(a) {
    var b = this.get_drag_data(a);
    this.options.autoscroll && this.manage_scroll(b), this.options.move_element &&
    ...
    return (b.prev_position = c), this.options.drag && this.options.drag.call(this.$player, a, b), (this.last_position =
      b.position), !1;
  }), (j.on_dragstop = function(a) {
    var b = this.get_drag_data(a);
    return (this.drag_start = !1), this.options.stop && this.options.stop.call(this.$player, a, b), this.helper &&
      this.options.remove_helper &&
    ...
    this.disable(), this.$container.off(this.ns), this.$document.off(this.ns), d.off(this.ns), a.removeData(
      this.$container,
      'drag'
    );
  ...
  (d.defaults = g), (d.generated_stylesheets = []), (d.sort_by_row_asc = function(b) {
    return (b = b.sort(function(b, c) {
      return b.row ||
        ((b = a(b).coords().grid), (c = a(c).coords().grid)), (b = e(b)), (c = e(c)), b.row > c.row ? 1 : -1;
    }));
  ...
  return (h.init = function() {
    this.options.resize.enabled &&
      this.setup_resize(), this.generate_grid_and_stylesheet(), this.get_widgets_from_DOM(), this.set_dom_grid_height(), this.set_dom_grid_width(), this.$wrapper.addClass(
      'ready'
    ), this.draggable(), this.options.resize.enabled && this.resizable(), this.options.center_widgets &&
      setTimeout(
        a.proxy(function() {
          this.center_widgets();
        }, this),
    ...
    c || (c = 1), d || (d = 1), e || f
      ? (
          (j = { col: e, row: f, size_x: c, size_y: d }),
          this.options.avoid_overlapped_widgets && this.empty_cells(e, f, c, d)
        )
      : (j = this.next_position(c, d));
    var k = a(b)
      .attr({ 'data-col': j.col, 'data-row': j.row, 'data-sizex': c, 'data-sizey': d })
      .addClass('gs-w')
      .appendTo(this.$el)
      .hide();
    ...
    return this.rows < l && this.add_faux_rows(l - this.rows), g && this.set_widget_max_size(k, g), h &&
      this.set_widget_min_size(k, h), this.set_dom_grid_width(), this.set_dom_grid_height(), this.drag_api.set_limits(
      this.cols * this.min_widget_width + (this.cols + 1) * this.options.widget_margins[0]
      ...
      setTimeout(
        ...
        0
      ), this.options.show_element.call(this, k, i), k;
    ...
    return 0 === c.children("span[class~='" + this.resize_handle_class + "']").length &&
      a(this.resize_handle_tpl).appendTo(c), this;
  }), (h.resize_widget = function(a, b, c, d) {
    var e = a.coords().grid;
    (this.is_resizing = !0), b || (b = e.size_x), c || (c = e.size_y), this.is_valid_row(e.row, c) ||
      this.add_faux_rows(Math.max(this.calculate_highest_row(e.row, c) - this.rows, 0)), this.is_valid_col(e.col, c) ||
      this.add_faux_cols(Math.max(this.calculate_highest_row(e.col, b) - this.cols, 0));
    var f = { col: e.col, row: e.row, size_x: b, size_y: c };
    return this.mutate_widget_in_gridmap(a, e, f), this.set_dom_grid_height(), this.set_dom_grid_width(), d &&
      d.call(this, f.size_x, f.size_y), (this.is_resizing = !1), a;
    ...
    return this.mutate_widget_in_gridmap(b, g, k), this.set_dom_grid_height(), this.set_dom_grid_width(), f &&
      f.call(this, k.size_x, k.size_y), b;
    ...
    return this.mutate_widget_in_gridmap(a, c, g), this.set_dom_grid_height(), this.set_dom_grid_width(), b &&
      b.call(this, g.size_x, g.size_y), a;
    ...
    return this.mutate_widget_in_gridmap(a, e, l), this.set_dom_grid_height(), this.set_dom_grid_width(), d &&
      d.call(this, l.size_x, l.size_y), a;
  }), (h.center_widgets = debounce(function() {
    var b,
      c = this.$wrapper.width();
    b = this.is_responsive()
      ? this.get_responsive_col_width()
      : this.options.widget_base_dimensions[0] + 2 * this.options.widget_margins[0];
    ...
    (c = d.sort_by_row_and_col_asc(c)), c.each(
    ...
    ), this.is_resizing || this.set_dom_grid_height(), this;
    ...
    a.isFunction(c) &&
      ((d = c), (c = !1)), (this.cells_occupied_by_placeholder = {}), (this.$widgets = this.$widgets.not(e));
    var g = this.widgets_below(e);
    return this.remove_from_gridmap(f), this.options.hide_element.call(
      this,
      e,
      a.proxy(function() {
        e.remove(), c ||
          ...
          ), this.set_dom_grid_height(), d && d.call(this, b);
      }, this)
    ), this;
  }), (h.remove_all_widgets = function(b) {
    return this.$widgets.each(
    ...
    return this.options.shift_widgets_up &&
      f &&
      ((d.row = f), b.attr('data-row', f), this.$el.trigger('gridster:positionchanged', [d]), (e = !0)), this.options
      .avoid_overlapped_widgets &&
      !this.can_move_to({ size_x: d.size_x, size_y: d.size_y }, d.col, d.row) &&
      (
        a.extend(d, this.next_position(d.size_x, d.size_y)),
        b.attr({ 'data-col': d.col, 'data-row': d.row, 'data-sizex': d.size_x, 'data-sizey': d.size_y }),
        (e = !0)
      ), b.data('coords', b.coords()), (b.data('coords').grid = d), this.add_to_gridmap(
      d,
      b
    ), this.update_widget_dimensions(b, d), this.options.resize.enabled && this.add_resize_handle(b), e;
    ...
    var c =
        b.size_x * (this.is_responsive() ? this.get_responsive_col_width() : this.options.widget_base_dimensions[0]) +
        (b.size_x - 1) * this.options.widget_margins[0],
      d = b.size_y * this.options.widget_base_dimensions[1] + (b.size_y - 1) * this.options.widget_margins[1];
    return a.data('coords').update({ width: c, height: d }), a.attr({
      'data-col': b.col,
      'data-row': b.row,
      'data-sizex': b.size_x,
      'data-sizey': b.size_y
    ...
    var b = this,
      c = a.extend(!0, {}, this.options.draggable, {
        ...
        limit: !0,
        start: function(c, d) {
          b.$widgets.filter('.player-revert').removeClass('player-revert'), (b.$player = a(this)), (b.$helper = a(
            d.$helper
          )), (b.helper = !b.$helper.is(b.$player)), b.on_start_drag.call(b, c, d), b.$el.trigger('gridster:dragstart');
        },
        stop: function(a, c) {
    ...
    return (this.resize_handle_tpl = a
      .map(b, function(a) {
        return c.replace('{type}', a);
      })
      .join('')), a.isArray(this.options.draggable.ignore_dragging) &&
      this.options.draggable.ignore_dragging.push('.' + this.resize_handle_class), this;
  }), (h.on_start_drag = function(b, c) {
    this.$helper
      .add(this.$player)
      .add(this.$wrapper)
      .addClass('dragging'), (this.highest_col = this.get_highest_occupied_cell().col), this.$player.addClass(
      'player'
    ), (this.player_grid_data = this.$player.coords().grid), (this.placeholder_grid_data = a.extend(
      {},
    ...
    )), (this.last_cols = []), (this.last_rows = []), (this.collision_api = this.$helper.collision(
      f,
    ...
    (this.colliders_data = this.collision_api.get_closest_colliders(f)), this.on_overlapped_column_change(
      this.on_start_overlapping_column,
      this.on_stop_overlapping_column
    ), this.on_overlapped_row_change(this.on_start_overlapping_row, this.on_stop_overlapping_row), this.helper &&
      this.$player &&
      this.$player.css({ left: b.position.left, top: b.position.top }), this.options.draggable.drag &&
      this.options.draggable.drag.call(this, a, b);
  }), (h.on_stop_drag = function(a, b) {
    this.$helper.add(this.$player).add(this.$wrapper).removeClass('dragging');
    var c = this.options.widget_margins,
      d = this.$preview_holder.attr('data-col'),
      e = this.$preview_holder.attr('data-row');
    (b.position.left = b.position.left + this.baseX - c[0] * d), (b.position.top =
      b.position.top + this.baseY - c[1] * e), (this.colliders_data = this.collision_api.get_closest_colliders(
      b.position
    ...
    ), (this.$changed = this.$changed.add(this.$player)), (this.placeholder_grid_data.el.coords().grid.col ===
    ...
    this.set_cells_player_occupies(
      f,
      g
    ), (this.$player.coords().grid.row = g), (this.$player.coords().grid.col = f), this.$player
      .addClass('player-revert')
      .removeClass('player')
      .attr({ 'data-col': f, 'data-row': g })
      .css({ left: '', top: '' }), this.options.draggable.stop &&
      this.options.draggable.stop.call(
        this,
        a,
        b
      ), this.$preview_holder.remove(), (this.$player = null), (this.$helper = null), (this.placeholder_grid_data = {}), (this.player_grid_data = {}), (this.cells_occupied_by_placeholder = {}), (this.cells_occupied_by_player = {}), (this.w_queue = {}), this.set_dom_grid_height(), this.set_dom_grid_width(), this
      .options.max_cols ===
      1 / 0 &&
      this.drag_api.set_limits(this.cols * this.min_widget_width + (this.cols + 1) * this.options.widget_margins[0]);
  }), (h.on_start_resize = function(b, c) {
    (this.$resized_widget = c.$player.closest(
      '.gs-w'
    )), (this.resize_coords = this.$resized_widget.coords()), (this.resize_wgd = this.resize_coords.grid), (this.resize_initial_width = this.resize_coords.coords.width), (this.resize_initial_height = this.resize_coords.coords.height), (this.resize_initial_sizex = this.resize_coords.grid.size_x), (this.resize_initial_sizey = this.resize_coords.grid.size_y), (this.resize_initial_col = this.resize_coords.grid.col), (this.resize_last_sizex = this.resize_initial_sizex), (this.resize_last_sizey = this.resize_initial_sizey), (this.resize_max_size_x = Math.min(
      this.resize_wgd.max_size_x || this.options.resize.max_size[0],
      this.options.max_cols - this.resize_initial_col + 1
    )), (this.resize_max_size_y =
      this.resize_wgd.max_size_y || this.options.resize.max_size[1]), (this.resize_min_size_x =
      this.resize_wgd.min_size_x || this.options.resize.min_size[0] || 1), (this.resize_min_size_y =
      this.resize_wgd.min_size_y ||
      this.options.resize.min_size[1] ||
      1), (this.resize_initial_last_col = this.get_highest_occupied_cell().col), this.set_dom_grid_width(
      this.cols
    ), (this.resize_dir = {
    ...
    }).appendTo(this.$el)), this.$resized_widget.addClass('resizing'), this.options.resize.start &&
      this.options.resize.start.call(this, b, c, this.$resized_widget), this.$el.trigger('gridster:resizestart');
  }), (h.on_stop_resize = function(b, c) {
    this.$resized_widget
      .removeClass('resizing')
      .css({ width: '', height: '', 'min-width': '', 'min-height': '' }), delay(
      a.proxy(function() {
      ...
      300
    ), this.set_dom_grid_width(), this.set_dom_grid_height(), this.options.max_cols === 1 / 0 &&
    ...
    if (
      (
        this.resize_dir.right
          ? (r = this.resize_initial_sizey)
          : this.resize_dir.bottom && (q = this.resize_initial_sizex),
        n
      )
    ) {
      var y = this.resize_initial_col + q - 1;
      n &&
        this.resize_initial_last_col <= y &&
        (this.set_dom_grid_width(Math.max(y + 1, this.cols)), this.cols < y && this.add_faux_cols(y - this.cols));
    }
    var z = {};
    !this.resize_dir.bottom && (z.width = Math.max(Math.min(this.resize_initial_width + d, u), v)), !this.resize_dir
      .right && (z.height = Math.max(Math.min(this.resize_initial_height + e, w), x)), this.$resized_widget.css(
      z
      ...
      (
        ...
        this.$resize_preview_holder
          .css({ width: '', height: '' })
          .attr({ 'data-row': this.$resized_widget.attr('data-row'), 'data-sizex': q, 'data-sizey': r })
      ), this.options.resize.resize &&
      this.options.resize.resize.call(this, a, b, this.$resized_widget), this.$el.trigger(
      'gridster:resize'
    ), (this.resize_last_sizex = q), (this.resize_last_sizey = r);
        ...
        j.each(
          a.proxy(function(b, c) {
            ...
            if (n.options.collision.wait_for_mouseup && n.drag_api.is_dragging)
              (n.placeholder_grid_data.col = h), (n.placeholder_grid_data.row = i), (n.cells_occupied_by_placeholder = n.get_cells_occupied(
                n.placeholder_grid_data
              )), n.$preview_holder.attr({ 'data-row': i, 'data-col': h });
            else if (e.size_x <= l && e.size_y <= k)
              if (
                n.is_swap_occupied(m.cols[0], e.row, e.size_x, e.size_y) ||
                n.is_player_in(m.cols[0], e.row) ||
                n.is_in_queue(m.cols[0], e.row, d)
              )
                if (
                  n.is_swap_occupied(g, e.row, e.size_x, e.size_y) ||
                  n.is_player_in(g, e.row) ||
                  n.is_in_queue(g, e.row, d)
                )
                  if (
                    n.is_swap_occupied(e.col, m.rows[0], e.size_x, e.size_y) ||
                    n.is_player_in(e.col, m.rows[0]) ||
                    n.is_in_queue(e.col, m.rows[0], d)
                  )
                    if (
                      n.is_swap_occupied(e.col, o, e.size_x, e.size_y) ||
                      n.is_player_in(e.col, o) ||
                      n.is_in_queue(e.col, o, d)
                    )
                      if (
                        n.is_swap_occupied(m.cols[0], m.rows[0], e.size_x, e.size_y) ||
                        n.is_player_in(m.cols[0], m.rows[0]) ||
                        n.is_in_queue(m.cols[0], m.rows[0], d)
                      )
                        for (var p = 0; l > p; p++)
                          for (var q = 0; k > q; q++) {
                            var r = m.cols[0] + p,
                              s = m.rows[0] + q;
                            if (
                              !n.is_swap_occupied(r, s, e.size_x, e.size_y) &&
                              !n.is_player_in(r, s) &&
                              !n.is_in_queue(r, s, d)
                            ) {
    ...
    for (var e = !1, f = 0; c > f; f++)
      for (var g = 0; d > g; g++) {
        ...
        i > parseInt(this.options.max_rows) && (e = !0), h > parseInt(this.options.max_cols) &&
          (e = !0), this.is_player_in(h, i) && (e = !0);
      }
    return e;
    ...
    for (var e = !0, f = 0; c > f; f++)
      for (var g = 0; d > g; g++) {
        ...
        i > parseInt(this.options.max_rows) && (e = !1), h > parseInt(this.options.max_cols) &&
          (e = !1), this.is_occupied(h, i) && !this.is_widget_queued_and_can_move(j) && (e = !1);
      }
    return e;
    ...
    for (var c in this.w_queue)
      if (
        'full' !== this.w_queue[c] &&
        this.w_queue[c].attr('data-col') === a.attr('data-col') &&
        this.w_queue[c].attr('data-row') === a.attr('data-row')
      ) {
        b = !0;
        for (
          var d = this.w_queue[c],
            e = parseInt(c.split('_')[0]),
            f = parseInt(c.split('_')[1]),
            g = d.coords().grid,
            h = 0;
          h < g.size_x;
          h++
    ...
    if (e in this.w_queue)
      if ('full' === this.w_queue[e]) d = !0;
        ...
        this.is_widget_under_player(g.col, g.row)
          ? this.w_queue[e].attr('data-col') === c.attr('data-col') &&
            this.w_queue[e].attr('data-row') === c.attr('data-row')
    ...
    ), (c = b.not(e)), { can_go_up: d.sort_by_row_asc(f), can_not_go_up: d.sort_by_row_desc(g) };
      ...
      a.proxy(function(a, b) {
        ...
        if (g) this.move_widget_to(f, g), this.set_placeholder(c, g + e.size_y);
          ...
          if (!h) {
            ...
            this.can_go_down(f) &&
              (console.log('In Move Down!'), this.move_widget_down(f, i), this.set_placeholder(c, d));
          }
        }
      }, this)
    ), this;
    ...
    return 'undefined' != typeof this.gridmap[a]
      ? 'undefined' != typeof this.gridmap[a][b] && this.gridmap[a][b] === !1
      : !0;
    ...
    return this.for_each_column_occupied(a, function(a) {
      ...
      for (
        d[a] = [];
        --h > 0 && (this.is_empty(a, h) || this.is_player(a, h) || (this.is_widget(a, h) && g[h].is(f)));

      )
        d[a].push(h), (e = e > h ? h : e);
      return 0 === d[a].length
        ? ((c = !1), !0)
    ...
    return this.for_each_column_occupied(a, function(f) {
      ...
      for (var h = b + 1; --h > 0 && (!this.is_widget(f, h) || this.is_player_in(f, h) || g[h].is(a.el)); )
        this.is_player(f, h) || this.is_placeholder_in(f, h) || this.is_player_in(f, h) || d[f].push(h), e > h &&
          (e = h);
      return 0 === d[f].length
        ? ((c = !1), !0)
    ...
    var d = a.coords().grid;
    return this.remove_from_gridmap(d), (d.row = c), (d.col = b), this.add_to_gridmap(d), a.attr('data-row', c), a.attr(
      'data-col',
      b
    ), this.update_widget_position(d, a), (this.$changed = this.$changed.add(a)), this;
  }), (h.move_widget = function(a, b, c, d) {
    var e = a.coords().grid,
      f = { col: b, row: c, size_x: e.size_x, size_y: e.size_y };
    return this.mutate_widget_in_gridmap(a, e, f), this.set_dom_grid_height(), this.set_dom_grid_width(), d &&
      d.call(this, f.col, f.row), a;
    ...
    var d = b.coords().grid,
      e = d.row,
      f = [];
    return c || (c = 1), this.can_go_up(b)
      ? void this.for_each_column_occupied(d, function(d) {
          if (-1 === a.inArray(b, f)) {
            var g = b.coords().grid,
              h = e - c;
            if (((h = this.can_go_up_to_row(g, d, h)), !h)) return !0;
            this.remove_from_gridmap(g), (g.row = h), this.add_to_gridmap(g), b.attr(
              'data-row',
              g.row
    ...
    if (-1 === a.inArray(b, f)) {
      ...
      this.remove_from_gridmap(h), j.each(
        a.proxy(function(b, c) {
          var d = a(c),
            e = d.coords().grid,
      ...
      ), (h.row = i), this.update_widget_position(h, b), b.attr('data-row', h.row), (this.$changed = this.$changed.add(
        b
      )), f.push(b);
    }
    ...
    return this.remove_from_gridmap(
      this.placeholder_grid_data
    ), (this.placeholder_grid_data.col = a), (this.placeholder_grid_data.row = b), this.add_to_gridmap(
      this.placeholder_grid_data,
      this.$player
    ), this;
    ...
    return 1 === c
      ...
      : (
          this.for_each_column_occupied(b, function(a) {
            return this.is_occupied(a, d) ||
            this.is_player(a, d) ||
            this.is_placeholder_in(a, d) ||
            this.is_player_in(a, d)
              ? ((e = !1), !0)
              : void 0;
          }),
          e
          ...
          'for_each/above': function() {
            for (
              ...
              !(
                ...
                this.is_widget(d, m) &&
                -1 === a.inArray(g[d][m], l) &&
                ((h = f.call(g[d][m], d, m)), l.push(g[d][m]), h)
              );

            );
          },
          'for_each/below': function() {
            for (m = e + 1, i = g[d].length; i > m; m++)
              this.is_widget(d, m) && -1 === a.inArray(g[d][m], l) && ((h = f.call(g[d][m], d, m)), l.push(g[d][m]));
          }
        };
      n[j] && n[j].call(this);
    }
    ...
    for (f = d; f >= b; f--)
      for (g = e; g >= c; g--)
        (h = this.is_widget(f, g)), h !== !1 &&
          ((i = h.data('coords').grid), i.col >= b && i.col <= d && i.row >= c && i.row <= e && (j = j.add(h)));
    return j;
    ...
    return (a = Math.min(b, Math.max(a, this.options.min_cols))), (this.container_width =
      (a + 1) * this.options.widget_margins[0] + a * this.min_widget_width), this.is_responsive()
      ? (this.$el.css({ 'min-width': '100%', 'max-width': '100%' }), this)
      : (this.$el.css('width', this.container_width), this);
  }), (h.is_responsive = function() {
    return (
      this.options.autogenerate_stylesheet &&
      'auto' === this.options.widget_base_dimensions[0] &&
      this.options.max_cols !== 1 / 0
    );
    ...
    return (this.min_widget_width = this.get_responsive_col_width()), this.generate_stylesheet(), this.update_widgets_dimensions(), this.drag_api.set_limits(
      this.cols * this.min_widget_width + (this.cols + 1) * this.options.widget_margins[0]
    ), this;
    ...
    return a
      ...
      : (
          this.$widgets.css({ 'margin-top': 'auto', 'margin-bottom': 'auto', 'min-height': 'auto' }),
    ...
    var c,
      ...
      f =
        this.is_responsive() &&
        this.options.responsive_breakpoint &&
        a(window).width() < this.options.responsive_breakpoint;
    b || (b = {}), b.cols || (b.cols = this.cols), b.rows || (b.rows = this.rows), b.namespace ||
      (b.namespace = this.options.namespace), b.widget_base_dimensions ||
      (b.widget_base_dimensions = this.options.widget_base_dimensions), b.widget_margins ||
      (b.widget_margins = this.options.widget_margins), this.is_responsive() &&
      (
        (b.widget_base_dimensions = [this.get_responsive_col_width(), b.widget_base_dimensions[1]]),
    ...
    for (this.generated_stylesheets.push(g), d.generated_stylesheets.push(g), c = 1; c <= b.cols + 1; c++)
      e +=
        ...
        c +
        '"] { left:' +
        (f ? this.options.widget_margins[0] : c * b.widget_margins[0] + (c - 1) * b.widget_base_dimensions[0]) +
        'px; }\n';
    for (c = 1; c <= b.rows + 1; c++)
      e +=
        ...
        c +
        '"] { top:' +
        (c * b.widget_margins[1] + (c - 1) * b.widget_base_dimensions[1]) +
        'px; }\n';
    for (var h = 1; h <= b.rows; h++)
      e +=
        ...
        h +
        '"] { height:' +
        (f ? 'auto' : h * b.widget_base_dimensions[1] + (h - 1) * b.widget_margins[1]) +
        (f ? '' : 'px') +
        '; }\n';
    for (var i = 1; i <= b.cols; i++) {
      ...
      e +=
        ...
        '"] { width:' +
        (f
          ? this.$wrapper.width() - 2 * this.options.widget_margins[0]
          : j > this.$wrapper.width() ? this.$wrapper.width() : j) +
        'px; }\n';
    }
    ...
    if (('' !== this.options.namespace && (c = c + '-' + this.options.namespace), !document.getElementById(c))) {
      ...
      (d.id = c), b.getElementsByTagName('head')[0].appendChild(d), d.setAttribute('type', 'text/css'), d.styleSheet
        ? (d.styleSheet.cssText = a)
        : d.appendChild(document.createTextNode(a)), this.remove_style_tags(), (this.$style_tags = this.$style_tags.add(
        d
      ));
    }
    return this;
    ...
    return a.isArray(this.gridmap[c]) || (this.gridmap[c] = []), 'undefined' == typeof this.gridmap[c][b] &&
      (this.gridmap[c][b] = !1), this.faux_grid.push(d), this;
    ...
    return (this.baseX = (f.width() - b) / 2), (this.baseY = this.$wrapper.offset().top), 'relative' ===
      this.$wrapper.css('position') && (this.baseX = this.baseY = 0), a.each(
      this.faux_grid,
      a.proxy(function(a, b) {
    ...
    ), this.is_responsive() && this.resize_responsive_layout(), this.options.center_widgets &&
      this.center_widgets(), this;
  }), (h.resize_widget_dimensions = function(b) {
    return b.widget_margins && (this.options.widget_margins = b.widget_margins), b.widget_base_dimensions &&
      (this.options.widget_base_dimensions = b.widget_base_dimensions), (this.min_widget_width =
      2 * this.options.widget_margins[0] + this.options.widget_base_dimensions[0]), (this.min_widget_height =
      2 * this.options.widget_margins[1] + this.options.widget_base_dimensions[1]), this.$widgets.each(
      a.proxy(function(b, c) {
        var d = a(c);
        this.resize_widget(d);
      }, this)
    ), this.generate_grid_and_stylesheet(), this.get_widgets_from_DOM(), this.set_dom_grid_height(), this.set_dom_grid_width(), this;
    ...
    (this.cols = Math.max(f, d, this.options.min_cols)), c !== 1 / 0 && c >= f && c < this.cols && (this.cols = c), this
      .drag_api &&
      this.drag_api.set_limits(this.cols * this.min_widget_width + (this.cols + 1) * this.options.widget_margins[0]);
    ...
    }), (this.rows = this.options.max_rows), (this.baseX =
      (f.width() - b) / 2), (this.baseY = this.$wrapper.offset().top), this.options.autogenerate_stylesheet &&
      this.generate_stylesheet(), this.generate_faux_grid(this.rows, this.cols);
  }), (h.destroy = function(b) {
    return this.$el.removeData('gridster'), a.each(this.$widgets, function() {
      a(this).removeData('coords');
    }), f.unbind('.gridster'), this.drag_api && this.drag_api.destroy(), this.resize_api &&
      this.resize_api.destroy(), this.$widgets.each(function(b, c) {
      a(c).coords().destroy();
